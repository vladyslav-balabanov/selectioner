...
namespace BreadersHomebook.Models
{
    public class SelectionistsWorkModel
    {
        ...
        public DesiasesResistances DesiasesResistance { get; set; }
        ...
        public void Print()
        {
            Console.WriteLine(
                string.Format(
                    "id:{0}; name:{1}; author:{2}; parents:{3}; productivity:{4}; fruitCharacteristics:{5}; frostResistance:{6}; pestsResistance:{7}; desiasesResistance:{8}; fonds:{9};",
                    Id, NameOfCultureVariety, Author, string.Join(",", ParentVarieties), Productivity,
                    string.Join(",", FruitCharacteristics), FrostResistance, PestsResistance, DesiasesResistance,
